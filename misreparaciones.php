...
if($tipo==1){
	$result = $mysql->query("SELECT * from reparaciones WHERE id_usr = $id ORDER BY fecha DESC limit $inicio,$cuantos");
...
<?php
  ...
  //si somos usuario 2 entonces tenemos que mostrar todos los registros en estado pendiente
	$result = $mysql->query("SELECT * FROM reparaciones where estado LIKE 'pendiente' ORDER BY fecha DESC limit $inicio,$cuantos");
while($row = $result->fetch_assoc()) {
    ?>
<tr>
<th scope="row"><?php echo $row['id'] ?></th>
...
?>
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
            ...
            <?php
     echo '<a class="page-link" href="./misreparaciones.php?p='.$anterior.'" tabindex="-1" style="color:black">Anterior</a>';
      ?>

    </li>
    <li class="page-item">
      <?php
     echo '<a class="page-link" href="./misreparaciones.php?p='.$siguiente.'" style="color:black">Siguiente</a>';
      ?>
    </li>
  </ul>
