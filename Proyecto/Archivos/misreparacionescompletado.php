...
<?php
  ...
  //si somos usuario 2 entonces tenemos que mostrar todos los registros en estado completado
	$result = $mysql->query("SELECT * FROM reparaciones where estado LIKE 'completado' ORDER BY fecha DESC limit $inicio,$cuantos");
...
?>
  <ul class="pagination justify-content-center">
    <li class="page-item">
            ...
            <?php
     echo '<a class="page-link" href="./misreparacionescompletado.php?p='.$anterior.'" tabindex="-1" style="color:black">Anterior</a>';
      ?>

    </li>
    <li class="page-item">
      <?php
     echo '<a class="page-link" href="./misreparacionescompletado.php?p='.$siguiente.'" style="color:black">Siguiente</a>';
      ?>
    </li>
  </ul>
