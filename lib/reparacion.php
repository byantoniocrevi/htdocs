...
//obtengo el nombre de usuario de la reparacion
			function getnombreclienterep($id){
				
		$nombre="";
				$resultado=false;
				$conexion = Conexion::conectarBD();
				$sql = "SELECT nombre FROM usuarios INNER JOIN reparaciones on reparaciones.id_usr = usuarios.id_usr  WHERE reparaciones.id='$id'";
...
//obtengo el correo del usuario de la reparacion
			function getcorreoclienterep($id){

				$correo="";
				$resultado=false;
				$conexion = Conexion::conectarBD();
				$sql = "SELECT email FROM usuarios INNER JOIN reparaciones on reparaciones.id_usr = usuarios.id_usr  WHERE reparaciones.id='$id'";
				$rs = $conexion->query($sql);
					while ($fila = $rs->fetch_assoc()){
